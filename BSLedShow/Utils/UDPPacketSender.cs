...
{
    public static class UDPPacketSender
    {
        //private static UdpClient _client = new UdpClient(Configuration.PluginConfig.Instance.LEDControllerIpAddress, Configuration.PluginConfig.Instance.LEDControllerPort);
        ...
        public static void SendBytes(byte[] bytes, int size)
        {
            try
            {
                UdpClient _client = new UdpClient(Configuration.PluginConfig.Instance.LEDControllerIpAddress, Configuration.PluginConfig.Instance.LEDControllerPort);
                _client.Send(bytes, size);
