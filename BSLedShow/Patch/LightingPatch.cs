...
namespace BSLedShow.Patch
{
    ...
    public class LightingEventsSubscriber
    {
        ...
        private static void Postfix(BeatmapCallbacksController __instance, IReadonlyBeatmapData ____beatmapData,
            float ____songTime)
        {
            ...
            Plugin.Instance.callbackData.Add(
                Plugin.Instance.CallbackController.AddBeatmapCallback<ColorBoostBeatmapEventData>(CallbacksHandler
                    .HandleBeatmapBoostLightEventCallback));
            Plugin.Instance.callbackData.Add(
                Plugin.Instance.CallbackController.AddBeatmapCallback<BasicBeatmapEventData>(CallbacksHandler
                    .HandleBeatmapLightEventCallback));
            Plugin.Instance.callbackData.Add(
                Plugin.Instance.CallbackController.AddBeatmapCallback<BPMChangeBeatmapEventData>(CallbacksHandler
                    .HandleBeatmapBPMChangingCallback));
        }
    }
    ...
    public class BeatMapScenePatch
    {
        ...
        {
            if (newScenesTransitionSetupData?.GetType() == typeof(StandardLevelScenesTransitionSetupDataSO) &&
                Configuration.PluginConfig.Instance.isBeatMapStartLEDEffectEnabled &&
                Configuration.PluginConfig.Instance.beatMapStartLEDEffectWaitForMillis &&
                Plugin.Instance.beatMapStartLEDEffectWaiterSW.ElapsedMilliseconds <
                Configuration.PluginConfig.Instance.beatMapStartLEDEffectDelayMillis)
            {
                Plugin.Instance.beatMapStartLEDEffectWaiterSW.Stop();
                minDuration += (Configuration.PluginConfig.Instance.beatMapStartLEDEffectDelayMillis -
                                Plugin.Instance.beatMapStartLEDEffectWaiterSW.ElapsedMilliseconds) / 1000f;
            }
    ...
    [HarmonyPatch(typeof(StandardLevelScenesTransitionSetupDataSO), nameof(StandardLevelScenesTransitionSetupDataSO.Init), new Type[]
        {
            typeof(string),
    ...
    [HarmonyPatch(typeof(StandardLevelScenesTransitionSetupDataSO), nameof(StandardLevelScenesTransitionSetupDataSO.Init), new Type[]
    {
        ...
        typeof(bool),
        typeof(RecordingToolManager.SetupData?)
    }, new [] { ArgumentType.Normal, ArgumentType.Ref, ArgumentType.Normal, ArgumentType.Normal, ArgumentType.Normal, ArgumentType.Normal, ArgumentType.Normal, ArgumentType.Normal, ArgumentType.Normal, ArgumentType.Normal, ArgumentType.Normal, ArgumentType.Normal, ArgumentType.Normal, ArgumentType.Normal, ArgumentType.Normal, ArgumentType.Normal, ArgumentType.Normal, ArgumentType.Normal, ArgumentType.Normal })]
    internal class NewLevelStarted
    {
        private static void Postfix(BeatmapLevel beatmapLevel, ColorScheme overrideColorScheme, BeatmapKey beatmapKey,
            EnvironmentsListModel environmentsListModel) //IPreviewBeatmapLevel
        {
            ...
            var targetEnvironmentInfo =
                environmentsListModel.GetEnvironmentInfoBySerializedName((string)environmentName);
            ...
            pluginInstance.envColors = new float[6][]
            {
                new float[]
                {
                    colorScheme.environmentColor0.r, colorScheme.environmentColor0.g, colorScheme.environmentColor0.b,
                    colorScheme.environmentColor0.a
                },
                new float[]
                {
                    colorScheme.environmentColor1.r, colorScheme.environmentColor1.g, colorScheme.environmentColor1.b,
                    colorScheme.environmentColor1.a
                },
                new float[]
                {
                    colorScheme.environmentColorW.r, colorScheme.environmentColorW.g, colorScheme.environmentColorW.b,
                    colorScheme.environmentColorW.a
                },
                new float[]
                {
                    colorScheme.environmentColor0Boost.r, colorScheme.environmentColor0Boost.g,
                    colorScheme.environmentColor0Boost.b, colorScheme.environmentColor0Boost.a
                },
                new float[]
                {
                    colorScheme.environmentColor1Boost.r, colorScheme.environmentColor1Boost.g,
                    colorScheme.environmentColor1Boost.b, colorScheme.environmentColor1Boost.a
                },
                new float[]
                {
                    colorScheme.environmentColorWBoost.r, colorScheme.environmentColorWBoost.g,
                    colorScheme.environmentColorWBoost.b, colorScheme.environmentColorWBoost.a
                }
            };
            ...
            {
                pluginInstance.LightsProcessor.RunLEDEffect(Configuration.PluginConfig.Instance.beatMapStartLEDEffectId,
                    new uint[] { 1 });
            ...
            pluginInstance.lightsProcessTask = Task.Run(() =>
            {
                ...
                while (!localCTToken.IsCancellationRequested)
                {
                    ...
                    Thread.Sleep((int)Math.Max(
                        (float)(1000.0 / Configuration.PluginConfig.Instance.ledUpdateSpeed - sw.ElapsedMilliseconds),
                        0));
                    sw.Restart();
                }
